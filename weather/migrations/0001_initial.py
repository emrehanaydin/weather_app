    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('standard', 'Standard')], default='standard', max_length=10, verbose_name='User Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='permission', to='weather.menu')),
            ],
        ),
    ]
