...
class RequestLogAdmin(admin.ModelAdmin):
    list_display = ('user', 'path', 'response_body',
...
class WeatherDataAdmin(admin.ModelAdmin):
    list_display = [
        'location_name', 'temperature_celsius', 'temperature_fahrenheit', 'condition_text', 'created_at',
        'update_at',
    ]
    list_filter = ['location_name']
    ordering = ['-update_at']
    search_fields = ['location_name', 'temperature_celsius',
